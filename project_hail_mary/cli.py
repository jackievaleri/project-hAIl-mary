"""Custom CLI for project-hAIl-mary.
...
def hello():
    ...
    typer.echo("This project's name is project-hAIl-mary")


@app.command()
def describe():
    """Describe the project."""
    typer.echo("Finding underrated fantasy football draft picks for our league.")
